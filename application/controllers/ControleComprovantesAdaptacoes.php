...
class ControleComprovantesAdaptacoes extends ControleDocumentos {
    ...
    /**
     * Adiciona o Comprovante de Adaptação no banco de dados
     * 
    ...
    public function add(//Atributos do Documento:
                        ...
                        //Atributos do Comprovante de Adaptação:
                        $num_paginas = '', $local_publicacao = '', $edicao = '',
                        $comprovante = '', $instituicao = '',
        ...
        //Validação dos campos do Comprovante de Adaptação
        $invalid_fields = array_merge($invalid_fields, $this->validate_parameters($num_paginas));
        ...
        $result = $this->add_documento(DOCUMENTOS_COMPROVANTES_ADAPTACOES_ID, $titulo, $autores, $generos, $categoria, $fontes,
        ...
        try {
            $this->DB->insert('ComprovanteAdaptacao', $fields, false);
        }
        catch (Exception $e) {
    ...
    /**
     * Atualiza o Comprovante de Adaptação no banco de dados
     * 
     * @return string Resultado da inserção no formato JSON
     */
    public function update(//Atributos do Documento:
        ...
        try {
            $this->DB->update('ComprovanteAdaptacao', $fields, $where);
        }
        catch (Exception $e) {
            Logger::log($e->getMessage(), __FILE__);
     ...
     */
    private function validate_parameters($num_paginas = '') {
