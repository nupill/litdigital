...
<div id="content">
	<h2>
		<a href="<?php echo ADMIN_URI; ?>"><?php echo __('Área administrativa');?></a> &raquo;
	 	...
	 	<?php echo __('Cadastrar fonte');?>
	 </h2>
	<br />
	<br />
    <form id="add" action="<?php echo ADMIN_FONTES_URI; ?>?action=add" method="post" class="inline">
    	<fieldset>
    		<legend><?php echo __('Preencha o campo abaixo para incluir uma fonte bibliográfica');?></legend>
    		<p><label for="descricao"><?php echo __('Descrição');?>*</label>
    		<input type="text" id="descricao" name="descricao" style="width: 900px" /></p>
    	</fieldset>
    ...
    var options = {
        ...
        success: function(response, status) {
            ...
            if (response && response.error == null) {
            	$('#status').html('<span class="success">'+"<?php echo __('Fonte cadastrada com sucesso');?>"+'!</span>');
            }
            else {
