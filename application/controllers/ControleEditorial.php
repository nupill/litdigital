...
class ControleEditorial extends ControleDocumentos {
    ...
    /**
     * Adiciona o Editorial no banco de dados
     *
    ...
    public function add(//Atributos do Documento:
        ...
        $result = $this->add_documento(DOCUMENTOS_HISTORIA_EDITORIAL_ID, $titulo, $autores, $generos, $categoria, $fontes,
        ...
        try {
            $this->DB->insert('Editorial', $fields, false);
        } catch (Exception $e) {
    ...
    /**
     * Atualiza o Editorial no banco de dados
     *
     * @return string Resultado da inserção no formato JSON
     */
    public function update(//Atributos do Documento:
        ...
        try {
            $this->DB->update('Editorial', $fields, $where);
        } catch (Exception $e) {
            Logger::log($e->getMessage(), __FILE__);
    ...
    /**
     * Valida os campos (parâmetros) da Ilustracao
     *
