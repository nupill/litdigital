...
<div id="content">
    ...
    <br />
    <form id="add" action="<?php echo ADMIN_DOCUMENTOS_AUDIOVISUAIS_URI; ?>?action=add" method="post" class="inline">
        <fieldset>
        ...
        <fieldset>
            ...
            <p><label for="genero"><?php echo __('Gênero literário');?>*</label>
             ...
             <select id="genero" name="genero" style="width: 385px">
                ...
                <button id="add_genero" class="disabled" title="<?php echo __('Adicionar à lista');?>">+</button>
                <div class="clear"></div>
        ...
        <fieldset>
            ...
            <p><label for="direitos_autorais"><?php echo __("Direitos autorais");?></label>
