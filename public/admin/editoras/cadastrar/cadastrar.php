...
<div id="content">
	<h2>
		<a href="<?php echo ADMIN_URI; ?>"><?php echo __('Área administrativa');?></a> &raquo;
	 	<a href="<?php echo ADMIN_EDITORAS_URI; ?>"><?php echo __('Editoras');?></a> &raquo;
	 	<?php echo __('Cadastrar editora');?>
	 </h2>
	<br />
	<br />
    <form id="add" action="<?php echo ADMIN_EDITORAS_URI; ?>?action=add" method="post" class="inline">
    	<fieldset>
    		<legend><?php echo __('Preencha os campos abaixo para incluir uma editora');?></legend>
    		<p><label for="nome"><?php echo __('Nome da Editora/Periódico');?>*</label>
    		<input type="text" id="nome" name="nome" style="width: 800px" /></p>
    		
    		<p><label for="periodico"><br /><input type="checkbox" id="periodico" name="periodico" /> <?php echo __('Periódico');?></label></p>
            ...
            <button id="add_local"  title="<?php echo __('Adicionar à lista');?>">+</button>
             <div class="clear"></div>
             <select id="locais" name="locais[]" multiple="multiple" size="5" style="width: 792px; margin-right: 4px" class="left"></select>
	    ...
	    var options = {
	        ...
	        success: function(response, status) {
	            ...
	            if (response && response.error == null) {
	            	$('#status').html('<span class="success">'+"<?php echo __('Editora cadastrada com sucesso');?>"+'!</span>');
	            }
	            else {
