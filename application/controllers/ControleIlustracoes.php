...
class ControleIlustracoes extends ControleDocumentos {
    ...
    /**
     * Adiciona a Ilustração no banco de dados
     *
    ...
    public function add(//Atributos do Documento:
                        ...
                        //Atributos da Ilustração: Sim, nenhum! \o/
        ...
        //Validação dos campos de Ilustracao
        ...
        $result = $this->add_documento(DOCUMENTOS_ILUSTRACOES_ID, $titulo, $autores, $generos, $categoria, $fontes,
        ...
        try {
            $this->DB->insert('Ilustracao', $fields, false);
       }
        catch (Exception $e) {
    ...
    /**
     * Atualiza a Ilustração no banco de dados
     *
     * @return string Resultado da inserção no formato JSON
     */
    public function update(//Atributos do Documento:
        ...
        try {
            $this->DB->update('Ilustracao', $fields, $where);
         }
        catch (Exception $e) {
            Logger::log($e->getMessage(), __FILE__);
