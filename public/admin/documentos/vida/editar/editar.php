...
$generos = $controle_documentos->get_generos(DOCUMENTOS_VIDA_ID);
...
$categorias = $controle_documentos->get_categorias(DOCUMENTOS_VIDA_ID);
...
<div id="content">
    <h2>
        ...
        <a href="<?php echo ADMIN_DOCUMENTOS_VIDA_URI; ?>"><?php echo __('Vida');?></a> &raquo;
        <?php echo __('Editar');?>
    </h2>
    <br />
    <form id="update" action="<?php echo ADMIN_DOCUMENTOS_VIDA_URI; ?>?action=update&id=<?php echo $id; ?>" method="post" class="inline">
        <fieldset>
            <legend><?php echo __('Títulos');?></legend>
            <p><label for="titulo"><?php echo __('Mídias');?>Título*</label>
        ...
        <fieldset>
            ...
            <p><label for="indice_assunto"><?php echo __('Índice do assunto');?></label>
                <input type="text" id="indice_assunto" name="indice_assunto" value="<?php echo $documento['indice_assunto']; ?>" /></p>
            <div class="clear"></div>
