...
//$fontes = $controle_documentos->get_fontes(DOCUMENTOS_ORIGINAIS_ID);
...
<div id="content">
    ...
    <br />
    <form id="add" action="<?php echo ADMIN_DOCUMENTOS_ORIGINAIS_URI; ?>?action=add" method="post" class="inline">
        <fieldset>
        ...
        <fieldset>
            ...
            <p><label for="direitos"><?php echo __('Direitos autorais');?>Direitos autorais</label>
