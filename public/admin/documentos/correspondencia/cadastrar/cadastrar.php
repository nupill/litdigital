...
//$fontes = $controle_documentos->get_fontes(DOCUMENTOS_CORRESPONDENCIAS_ID);
...
<div id="content">
    ...
    <br />
    <form id="add" action="<?php echo ADMIN_DOCUMENTOS_CORRESPONDENCIAS_URI; ?>?action=add" method="post" class="inline">
        <fieldset>
        ...
        <fieldset>
            ...
            <p><label for="destinatario"><?php echo __('Destinatário');?></label>
                <input type="text" id="destinatario" name="destinatario" /></p>
            <div class="clear"></div>
