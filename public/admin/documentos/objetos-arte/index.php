...
require_once(APPLICATION_PATH . '/controllers/ControleObjetosArte.php');
...
switch ($action) {
    ...
    case 'update':
        ...
        //Atributos do Objeto de Arte:
        //$atribute = isset($_POST['atribute']) ? $_POST['atribute'] : ''; // Sim, não há nenhum.
        ...
        $controller = ControleObjetosArte::getInstance();
        if ($action == 'add') {
    ...
    case 'getTableData':
        $controller = ControleObjetosArte::getInstance();
        $_GET['sTable'] = 'ObjetoArte'; //Nome da tabela
        $_GET['iTypeId'] = DOCUMENTOS_OBJETOS_ARTE_ID; //ID do tipo do documento
    ...
    default:
        ...
        $template->set_content_file('admin/documentos/objetos-arte/objetos-arte.php');
