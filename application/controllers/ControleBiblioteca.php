...
class ControleBiblioteca extends ControleDocumentos {
    ...
    /**
     * Adiciona a Biblioteca no banco de dados
     *
    ...
    public function add(//Atributos do Documento:
        ...
        //Validação dos campos da Biblioteca
        ...
        $result = $this->add_documento(DOCUMENTOS_BIBLIOTECA_ID, $titulo, $autores, $generos, $categoria, $fontes,
        ...
        try {
            $this->DB->insert('Biblioteca', $fields, false);
        } catch (Exception $e) {
    ...
    /**
     * Atualiza a Biblioteca no banco de dados
     *
     * @return string Resultado da inserção no formato JSON
     */
    public function update(//Atributos do Documento:
        ...
        try {
            $this->DB->update('Biblioteca', $fields, $where);
        } catch (Exception $e) {
            Logger::log($e->getMessage(), __FILE__);
    ...
    /**
     * Valida os campos (parâmetros) da Biblioteca
     *
