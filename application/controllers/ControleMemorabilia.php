...
class ControleMemorabilia extends ControleDocumentos {
    ...
    /**
     * Adiciona a Memorabilia no banco de dados
     *
    ...
    public function add(//Atributos do Documento:
                        ...
                        //Atributos da Memorabilia:
                        $num_paginas = '', $local = '', $num_livro_ata = '',
                        $evento = '', $promocao = '', $local_realizacao = '',
                        $organizador = '', $tipo_publicacao = '',
        ...
        $invalid_fields = $this->validate_parameters_documentos($titulo, $autores,
                                                                ...
                                                                $estado, $ano_producao,
                                                                $idiomas);
        //Validação dos campos da Memorabilia
        $invalid_fields = array_merge($invalid_fields, $this->validate_parameters($num_paginas, $num_livro_ata));
        ...
        $result = $this->add_documento(DOCUMENTOS_MEMORABILIA_ID, $titulo, $autores, $generos, $categoria, $fontes,
    ...
    /**
     * Atualiza a Memorabilia no banco de dados
     *
     * @return string Resultado da inserção no formato JSON
     */
    public function update(//Atributos do Documento:
        ...
        try {
            $this->DB->update('Memorabilia', $fields, $where);
        }
        catch (Exception $e) {
            Logger::log($e->getMessage(), __FILE__);
    ...
    /**
     * Valida os campos (parâmetros) da Memorabilia
     *
     * @return array Campos que não passaram no teste de validação
     */
    private function validate_parameters($num_paginas = '', $num_livro_ata = '') {
        ...
        if ($num_livro_ata && !is_numeric($num_livro_ata)) {
            $invalid_fields['num_livro_ata'] = 'Número do livro de atas inválido';
        }
