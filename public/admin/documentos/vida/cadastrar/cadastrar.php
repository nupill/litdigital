...
//$fontes = $controle_documentos->get_fontes(DOCUMENTOS_VIDA_ID);
...
<div id="content">
    ...
    <br />
    <form id="add" action="<?php echo ADMIN_DOCUMENTOS_VIDA_URI; ?>?action=add" method="post" class="inline">
        <fieldset>
        ...
        <fieldset>
            ...
            <p><label for="indice_assunto"><?php echo __('Índice do assunto');?></label>
                <input type="text" id="indice_assunto" name="indice_assunto" /></p>
            <div class="clear"></div>
