...
require_once(APPLICATION_PATH . '/controllers/ControleObra.php');
...
switch ($action) {
    ...
    case 'update':
        ...
        $controller = ControleObra::getInstance();
        if ($action == 'add') {
    ...
    case 'getTableData':
        $controller = ControleObra::getInstance();
        $_GET['sTable'] = 'Obra'; //Nome da tabela
        $_GET['iTypeId'] = DOCUMENTOS_OBRA_ID; //ID do tipo do documento
    ...
    default:
        ...
        $template->set_content_file('admin/documentos/obra/obra.php');
