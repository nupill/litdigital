...
class ControleOriginais extends ControleDocumentos {
    ...
    /**
     * Adiciona o Original no banco de dados
     *
    ...
    public function add(//Atributos do Documento:
                        ...
                        //Atributos do Original:
                        $pseudonimo = '', $titulo_alternativo = '',
                        $subtitulo = '', $local = '', $volume = '',
                        $num_paginas = '',
        ...
        //Validação dos campos de Original
        ...
        $result = $this->add_documento(DOCUMENTOS_ORIGINAIS_ID, $titulo, $autores, $generos, $categoria, $fontes,
        ...
        try {
            $this->DB->insert('Originais', $fields, false);
        }
        catch (Exception $e) {
    ...
    /**
     * Atualiza o Original no banco de dados
     *
     * @return string Resultado da inserção no formato JSON
     */
    public function update(//Atributos do Documento:
        ...
        //Validação dos campos de Originais
        $invalid_fields = $this->validate_parameters($volume, $num_paginas);
        ...
        try {
            $this->DB->update('Originais', $fields, $where);
        }
        catch (Exception $e) {
            Logger::log($e->getMessage(), __FILE__);
