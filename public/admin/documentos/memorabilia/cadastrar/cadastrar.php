...
//$fontes = $controle_documentos->get_fontes(DOCUMENTOS_MEMORABILIA_ID);
...
<div id="content">
    ...
    <br />
    <form id="add" action="<?php echo ADMIN_DOCUMENTOS_MEMORABILIA_URI; ?>?action=add" method="post" class="inline">
        <fieldset>
        ...
        <fieldset>
            ...
            <p><label for="num_livro_ata"><?php echo __('Número do livro de atas');?></label>
                <input type="text" id="num_livro_ata" name="num_livro_ata" /></p>
            <div class="clear"></div>
            <p><label for="evento"><?php echo __('Número do evento');?></label>
                <input type="text" id="evento" name="evento" /></p>
            <p><label for="promocao"><?php echo __('Promotor');?></label>
                <input type="text" id="promocao" name="promocao" /></p>
