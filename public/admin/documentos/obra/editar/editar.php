...
$generos = $controle_documentos->get_generos(DOCUMENTOS_OBRA_ID);

$idiomasAtuais = $controle_documentos->get_idiomas_new($id, array('id', 'descricao'));
$idiomas = $controle_documentos->get_idiomas();

$categorias = $controle_documentos->get_categorias(DOCUMENTOS_OBRA_ID);
...
<div id="content">
    <h2>
        ...
        <a href="<?php echo ADMIN_DOCUMENTOS_OBRA_URI; ?>"><?php echo __('Obra');?></a> &raquo;
        <?php echo __('Editar');?>
    </h2>
    <br />
    <form id="update" action="<?php echo ADMIN_DOCUMENTOS_OBRA_URI; ?>?action=update&id=<?php echo $id; ?>" method="post" class="inline">
        <fieldset>
        ...
        <fieldset>
            ...
            <div class="clear"></div>
            <p><label for="sigla"><?php echo __('Sigla');?></label>
                <input type="text" id="sigla" name="sigla" value="<?php echo $documento['sigla']; ?>" /></p>
            <div class="clear"></div>
