...
require_once(APPLICATION_PATH . '/controllers/ControleBiblioteca.php');
...
switch ($action) {
    ...
    case 'update':
        ...
        $controller = ControleBiblioteca::getInstance();
        if ($action == 'add') {
    ...
    case 'getTableData':
        $controller = ControleBiblioteca::getInstance();
        $_GET['sTable'] = 'Biblioteca'; //Nome da tabela
        $_GET['iTypeId'] = DOCUMENTOS_BIBLIOTECA_ID; //ID do tipo do documento
    ...
    default:
        ...
        $template->set_content_file('admin/documentos/biblioteca/biblioteca.php');
