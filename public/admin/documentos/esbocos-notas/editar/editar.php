...
$generos = $controle_documentos->get_generos(DOCUMENTOS_ESBOCOS_NOTAS_ID);
...
$categorias = $controle_documentos->get_categorias(DOCUMENTOS_ESBOCOS_NOTAS_ID);
...
<div id="content">
    <h2>
        ...
        <a href="<?php echo ADMIN_DOCUMENTOS_ESBOCOS_NOTAS_URI; ?>"><?php echo __('Esboços e Notas');?></a> &raquo;
        <?php echo __('Editar');?>
    </h2>
    <br />
    <form id="update" action="<?php echo ADMIN_DOCUMENTOS_ESBOCOS_NOTAS_URI; ?>?action=update&id=<?php echo $id; ?>" method="post" class="inline">
        <fieldset>
