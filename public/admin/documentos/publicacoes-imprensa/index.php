...
require_once(APPLICATION_PATH . '/controllers/ControlePublicacoesImprensa.php');
...
switch ($action) {
    ...
    case 'update':
        ...
        $num_fasciculo = isset($_POST['num_fasciculo']) ? $_POST['num_fasciculo'] : '';
        ...
        $controller = ControlePublicacoesImprensa::getInstance();
        if ($action == 'add') {
            exit($controller->add(//Atributos do Documento:
                            ...
                            $data_inicial, $data_final, $num_fasciculo,
    ...
    case 'getTableData':
        $controller = ControlePublicacoesImprensa::getInstance();
        $_GET['sTable'] = 'PublicacaoImprensa'; //Nome da tabela
        $_GET['iTypeId'] = DOCUMENTOS_PUBLICACOES_IMPRENSA_ID; //ID do tipo do documento
    ...
    default:
        ...
        $template->set_content_file('admin/documentos/publicacoes-imprensa/publicacoes-imprensa.php');
