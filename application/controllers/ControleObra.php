...
class ControleObra extends ControleDocumentos {
    ...
    /**
     * Adiciona a Obra no banco de dados
     *
    ...
    public function add(//Atributos do Documento:
        ...
        $result = $this->add_documento(DOCUMENTOS_OBRA_ID, $titulo, $autores, $generos, $categoria, $fontes,
        ...
        try {
            $this->DB->insert('Obra', $fields, false);
        }
        catch (Exception $e) {
    ...
    /**
     * Atualiza a Obra no banco de dados
     *
     * @return string Resultado da inserção no formato JSON
     */
    public function update(//Atributos do Documento:
        ...
        try {
            $this->DB->update('Obra', $fields, $where);
        }
        catch (Exception $e) {
            Logger::log($e->getMessage(), __FILE__);
    ...
    /**
     * Valida os campos (parâmetros) da Obra
     *
