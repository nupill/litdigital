...
require_once(APPLICATION_PATH . '/controllers/ControleOriginais.php');
...
switch ($action) {
    ...
    case 'update':
        ...
        $controller = ControleOriginais::getInstance();
        if ($action == 'add') {
            exit($controller->add(//Atributos do Documento:
                            ...
                            //Atributos do Original:
                            $pseudonimo, $titulo_alternativo, $subtitulo, $local,
                            $volume, $num_paginas,
    ...
    case 'getTableData':
        $controller = ControleOriginais::getInstance();
        $_GET['sTable'] = 'Originais'; //Nome da tabela
        $_GET['iTypeId'] = DOCUMENTOS_ORIGINAIS_ID; //ID do tipo do documento
    ...
    default:
        ...
        $template->set_content_file('admin/documentos/originais/originais.php');
