...
$generos = $controle_documentos->get_generos(DOCUMENTOS_ORIGINAIS_ID);

$idiomasAtuais = $controle_documentos->get_idiomas_new($id, array('id', 'descricao'));
$idiomas = $controle_documentos->get_idiomas();

$categorias = $controle_documentos->get_categorias(DOCUMENTOS_ORIGINAIS_ID);
...
<div id="content">
    <h2>
        ...
        <a href="<?php echo ADMIN_DOCUMENTOS_ORIGINAIS_URI; ?>"><?php echo __('Originais');?></a> &raquo;
        <?php echo __('Editar');?>
    </h2>
    <br />
    <form id="update" action="<?php echo ADMIN_DOCUMENTOS_ORIGINAIS_URI; ?>?action=update&id=<?php echo $id; ?>" method="post" class="inline">
        <fieldset>
            ...
            <p><label for="estado"><?php echo __('Estado de conservação');?></label>
                <select id="estado" name="estado">
                    ...
                    <option <?php if ($documento['estado'] == 'Muito bom')
                        echo 'selected="selected"'; ?>><?php echo __('Muito bom');?></option>
                    <option <?php if ($documento['estado'] == 'Bom')
                        echo 'selected="selected"'; ?>><?php echo __('Bom');?></option>
                    <option <?php if ($documento['estado'] == 'Regular')
                        echo 'selected="selected"'; ?>><?php echo __('Regular');?></option>
                    <option <?php if ($documento['estado'] == 'Péssimo')
                        echo 'selected="selected"'; ?>><?php echo __('Péssimo');?></option>
                </select></p>
        </fieldset>
        <fieldset>
            ...
            <p><label for="pseudonimo"><?php echo __('Pseudônimo');?></label>
                <input type="text" id="pseudonimo" name="pseudonimo" value="<?php echo $documento['pseudonimo']; ?>" /></p>
