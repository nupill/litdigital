...
$generos = $controle_documentos->get_generos(DOCUMENTOS_COMPROVANTES_ADAPTACOES_ID);

$idiomasAtuais = $controle_documentos->get_idiomas_new($id, array('id', 'descricao'));
$idiomas = $controle_documentos->get_idiomas();

$categorias = $controle_documentos->get_categorias(DOCUMENTOS_COMPROVANTES_ADAPTACOES_ID);
...
<div id="content">
    <h2>
        ...
        <a href="<?php echo ADMIN_DOCUMENTOS_COMPROVANTES_ADAPTACOES_URI; ?>"><?php echo __('Comprovantes de Adaptações');?></a> &raquo;
        <?php echo __('Editar');?>
    </h2>
    <br />
    <form id="update" action="<?php echo ADMIN_DOCUMENTOS_COMPROVANTES_ADAPTACOES_URI; ?>?action=update&id=<?php echo $id; ?>" method="post" class="inline">
        <fieldset>
        ...
        <fieldset>
            ...
            <div class="clear"></div>
            <p><label for="comprovante"><?php echo __('Comprovante');?></label>
                <input type="text" id="comprovante" name="comprovante" value="<?php echo $documento['comprovante']; ?>" /></p>
            <p><label for="instituicao"><?php echo __('Instituição');?></label>
                <input type="text" id="instituicao" name="instituicao" value="<?php echo $documento['instituicao']; ?>" /></p>
            <div class="clear"></div>
