...
class ControleNotas extends ControleDocumentos {
    ...
    public function add(//Atributos do Documento:
        ...
        //Validação dos campos de Esboço e notas
        ...
        $result = $this->add_documento(DOCUMENTOS_ESBOCOS_NOTAS_ID, $titulo, $autores, $generos, $categoria, $fontes,
        ...
        try {
            $this->DB->insert('Nota', $fields, false);
         }
        catch (Exception $e) {
    ...
    public function update(//Atributos do Documento:
        ...
        //Validação dos campos de Edicao e Notas
        $invalid_fields = $this->validate_parameters($num_paginas);
        ...
        try {
            $this->DB->update('Nota', $fields, $where);
        }
        catch (Exception $e) {
            Logger::log($e->getMessage(), __FILE__);
    ...
    /**
     * Valida os campos (parâmetros) da Nota
     *
