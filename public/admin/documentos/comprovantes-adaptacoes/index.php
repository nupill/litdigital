...
require_once(APPLICATION_PATH . '/controllers/ControleComprovantesAdaptacoes.php');
...
switch ($action) {
    ...
    case 'update':
        ...
        $controller = ControleComprovantesAdaptacoes::getInstance();
        if ($action == 'add') {
            exit($controller->add(//Atributos do Documento:
                            ...
                            //Atributos do Comprovante de Adaptação:
                            $num_paginas, $local_publicacao, $edicao, $comprovante,
                            $instituicao,
    ...
    case 'getTableData':
        $controller = ControleComprovantesAdaptacoes::getInstance();
        $_GET['sTable'] = 'ComprovanteAdaptacao'; //Nome da tabela
        $_GET['iTypeId'] = DOCUMENTOS_COMPROVANTES_ADAPTACOES_ID; //ID do tipo do documento
    ...
    default:
        ...
        $template->set_content_file('admin/documentos/comprovantes-adaptacoes/comprovantes-adaptacoes.php');
