...
$generos = $controle_documentos->get_generos(DOCUMENTOS_COMPROVANTES_CRITICA_ID);
...
$categorias = $controle_documentos->get_categorias(DOCUMENTOS_COMPROVANTES_CRITICA_ID);
...
<div id="content">
    <h2>
        ...
        <a href="<?php echo ADMIN_DOCUMENTOS_COMPROVANTES_CRITICA_URI; ?>"><?php echo __('Comprovantes de Crítica');?></a> &raquo;
        <?php echo __('Editar');?>
    </h2>
    <br />
    <form id="update" action="<?php echo ADMIN_DOCUMENTOS_COMPROVANTES_CRITICA_URI; ?>?action=update&id=<?php echo $id; ?>" method="post" class="inline">
        <fieldset>
        ...
        <fieldset>
            ...
            <p><label for="volume"><?php echo __('Volume');?></label>
                <input type="text" id="volume" name="volume" value="<?php echo $documento['volume']; ?>" /></p>
            ...
            <p><label for="artigo"><?php echo __('Artigo');?></label>
                <input type="text" id="artigo" name="artigo" value="<?php echo $documento['artigo']; ?>" /></p>
            <div class="clear"></div>
            <p><label for="local_publicacao"><?php echo __('Local de publicação');?></label>
                <input type="text" id="local_publicacao" name="local_publicacao" value="<?php echo $documento['local_publicacao']; ?>" /></p>
            <p><label for="edicao"><?php echo __('Edição');?></label>
                <input type="text" id="edicao" name="edicao" value="<?php echo $documento['edicao']; ?>" /></p>
            <p><label for="local_realizacao"><?php echo __('Local da realização');?></label>
                <input type="text" id="local_realizacao" name="local_realizacao" value="<?php echo $documento['local_realizacao']; ?>" /></p>
            <div class="clear"></div>
            <p><label for="organizador"><?php echo __('Organizador');?></label>
                <input type="text" id="organizador" name="organizador" value="<?php echo $documento['organizador']; ?>" /></p>
            <p><label for="tipo_publicacao"><?php echo __('Tipo de publicação');?></label>
                <input type="text" id="tipo_publicacao" name="tipo_publicacao" value="<?php echo $documento['tipo_publicacao']; ?>" /></p>
            <p><label for="autor_capitulo"><?php echo __('Autor do capítulo');?></label>
                <input type="text" id="autor_capitulo" name="autor_capitulo" value="<?php echo $documento['autor_capitulo']; ?>" /></p>
            <div class="clear"></div>
            <p><label for="titulo_capitulo"><?php echo __('Título do capítulo');?></label>
                <input type="text" id="titulo_capitulo" name="titulo_capitulo" value="<?php echo $documento['titulo_capitulo']; ?>" /></p>
            <p><label for="pag_inicial_capitulo"><?php echo __('Página inicial do capítulo');?></label>
                <input type="text" id="pag_inicial_capitulo" name="pag_inicial_capitulo" value="<?php echo $documento['pag_inicial_capitulo']; ?>" /></p>
            <p><label for="pag_final_capitulo"><?php echo __('Página final do capítulo');?></label>
                <input type="text" id="pag_final_capitulo" name="pag_final_capitulo" value="<?php echo $documento['pag_final_capitulo']; ?>" /></p>
            <div class="clear"></div>
            <p><label for="pag_inicial_artigo"><?php echo __('Página inicial do artigo');?></label>
                <input type="text" id="pag_inicial_artigo" name="pag_inicial_artigo" value="<?php echo $documento['pag_inicial_artigo']; ?>" /></p>
            <p><label for="pag_final_artigo"><?php echo __('Página final do artigo');?></label>
                <input type="text" id="pag_final_artigo" name="pag_final_artigo" value="<?php echo $documento['pag_final_artigo']; ?>" /></p>
            <p><label for="congresso"><?php echo __('Nome do congresso');?></label>
                <input type="text" id="congresso" name="congresso" value="<?php echo $documento['congresso']; ?>" /></p>
            <div class="clear"></div>
