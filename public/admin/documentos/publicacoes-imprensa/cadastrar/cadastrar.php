...
//$fontes = $controle_documentos->get_fontes(DOCUMENTOS_PUBLICACOES_IMPRENSA_ID);
...
<div id="content">
    ...
    <br />
    <form id="add" action="<?php echo ADMIN_DOCUMENTOS_PUBLICACOES_IMPRENSA_URI; ?>?action=add" method="post" class="inline">
        <fieldset>
        ...
        <fieldset>
            ...
            <p><label for="fonte"><?php echo __('Autores');?>*</label>
	            ...
	            <button id="rem_autor" disabled="disabled" class="disabled" title="Remover da lista">-</button>
            </p>
        </fieldset>
        <fieldset>
        ...
        <fieldset>
            ...
            <p><label for="data_inicial"><?php echo __('Data inicial');?></label>
                <input type="text" id="data_inicial" name="data_inicial" /></p>
            <p><label for="data_final"><?php echo __('Data final');?></label>
                <input type="text" id="data_final" name="data_final" /></p>
            <div class="clear"></div>
            <p><label for="num_fasciculo"><?php echo __('Número do fascículo');?></label>
                <input type="text" id="num_fasciculo" name="num_fasciculo" /></p>
            <div class="clear"></div>
