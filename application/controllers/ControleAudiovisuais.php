...
class ControleAudiovisuais extends ControleDocumentos {
    ...
    /**
     * Adiciona o Audiovisual no banco de dados
     *
    ...
    public function add(//Atributos do Documento:
        ...
        //Validação dos campos do Audiovisual
        $invalid_fields = array_merge($invalid_fields, $this->validate_parameters($volume));
        ...
        $result = $this->add_documento(DOCUMENTOS_AUDIOVISUAIS_ID, $titulo, $autores, $generos, $categoria, $fontes,
		                               $id_material, $editora_id, $abrangencia, $direitos, $acervo_id,
        ...
        try {
            $this->DB->insert('Audiovisual', $fields, false);
        }
        catch (Exception $e) {
    ...
    /**
     * Atualiza o Audiovisual no banco de dados
     *
     * @return string Resultado da inserção no formato JSON
     */
    public function update(//Atributos do Documento:
        ...
        $result = $this->update_documento($id, $titulo, $autores, $generos, $categoria, $fontes, $id_material,
                                          $editora_id, $abrangencia, $direitos, $acervo_id,
                                          $localizacao, $estado, $descricao, $ano_producao, $dimensao, $idiomas);
        ...
        try {
            $this->DB->update('Audiovisual', $fields, $where);
        }
        catch (Exception $e) {
            Logger::log($e->getMessage(), __FILE__);
    ...
    /**
     * Valida os campos (parâmetros) do Audiovisual
     *
     * @return array Campos que não passaram no teste de validação
     */
    private function validate_parameters($volume = '') {
