...
require_once(APPLICATION_PATH . '/controllers/ControleVida.php');
...
switch ($action) {
    ...
    case 'update':
        ...
        $indice_assunto = isset($_POST['indice_assunto']) ? $_POST['indice_assunto'] : '';
        ...
        $controller = ControleVida::getInstance();
        if ($action == 'add') {
    ...
    case 'getTableData':
        $controller = ControleVida::getInstance();
        $_GET['sTable'] = 'Vida'; //Nome da tabela
        $_GET['iTypeId'] = DOCUMENTOS_VIDA_ID; //ID do tipo do documento
    ...
    default:
        ...
        $template->set_content_file('admin/documentos/vida/vida.php');
