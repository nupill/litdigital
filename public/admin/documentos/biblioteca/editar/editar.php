...
$generos = $controle_documentos->get_generos(DOCUMENTOS_BIBLIOTECA_ID);
...
$categorias = $controle_documentos->get_categorias(DOCUMENTOS_BIBLIOTECA_ID);
...
<div id="content">
    <h2>
        ...
        <a href="<?php echo ADMIN_DOCUMENTOS_BIBLIOTECA_URI; ?>"><?php echo __('Biblioteca');?></a> &raquo;
        <?php echo __('Editar');?>
    </h2>
    <br />
    <form id="update" action="<?php echo ADMIN_DOCUMENTOS_BIBLIOTECA_URI; ?>?action=update&id=<?php echo $id; ?>" method="post" class="inline">
        <fieldset>
        ...
        <fieldset>
            ...
            <p><label for="cdu">CDU</label>
                <input type="text" id="cdu" name="cdu" value="<?php echo $documento['CDU']; ?>" /></p>
            <div class="clear"></div>
