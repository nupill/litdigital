...
//$fontes = $controle_documentos->get_fontes(DOCUMENTOS_COMPROVANTES_EDICOES_ID);
...
<div id="content">
    ...
    <br />
    <form id="add" action="<?php echo ADMIN_DOCUMENTOS_COMPROVANTES_EDICOES_URI; ?>?action=add" method="post" class="inline">
        <fieldset>
        ...
        <fieldset>
            ...
            <p><label for="capitulo"><?php echo __('Capítulo');?></label>
                <input type="text" id="capitulo" name="capitulo" /></p>
            <div class="clear"></div>
            <p><label for="pag_inicial"><?php echo __('Página inicial');?></label>
                <input type="text" id="pag_inicial" name="pag_inicial" /></p>
            <p><label for="pag_final"><?php echo __('Página final');?></label>
                <input type="text" id="pag_final" name="pag_final" /></p>
            <p><label for="tradutor"><?php echo __('Tradutor');?></label>
                <input type="text" id="tradutor" name="tradutor" /></p>
            <div class="clear"></div>
