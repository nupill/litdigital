...
//$fontes = $controle_documentos->get_fontes(DOCUMENTOS_COMPROVANTES_ADAPTACOES_ID);
...
<div id="content">
    ...
    <br />
    <form id="add" action="<?php echo ADMIN_DOCUMENTOS_COMPROVANTES_ADAPTACOES_URI; ?>?action=add" method="post" class="inline">
        <fieldset>
        ...
        <fieldset>
            ...
            <p><label for="comprovante"><?php echo __('Comprovante');?></label>
                <input type="text" id="comprovante" name="comprovante" /></p>
            <p><label for="instituicao"><?php echo __('Instituição');?></label>
                <input type="text" id="instituicao" name="instituicao" /></p>
            <div class="clear"></div>
