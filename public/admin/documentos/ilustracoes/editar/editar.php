...
$generos = $controle_documentos->get_generos(DOCUMENTOS_ILUSTRACOES_ID);
...
$categorias = $controle_documentos->get_categorias(DOCUMENTOS_ILUSTRACOES_ID);
...
<div id="content">
    <h2>
        ...
        <a href="<?php echo ADMIN_DOCUMENTOS_ILUSTRACOES_URI; ?>"><?php echo __('Ilustrações');?></a> &raquo;
        <?php echo __('Editar');?>
    </h2>
    <br />
    <form id="update" action="<?php echo ADMIN_DOCUMENTOS_ILUSTRACOES_URI; ?>?action=update&id=<?php echo $id; ?>" method="post" class="inline">
        <fieldset>
