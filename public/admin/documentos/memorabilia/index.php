...
require_once(APPLICATION_PATH . '/controllers/ControleMemorabilia.php');
...
switch ($action) {
    ...
    case 'update':
        ...
        $num_livro_ata = isset($_POST['num_livro_ata']) ? $_POST['num_livro_ata'] : '';
        ...
        $controller = ControleMemorabilia::getInstance();
        if ($action == 'add') {
            exit($controller->add(//Atributos do Documento:
                            ...
                            //Atributos da Memorabilia:
                            $num_paginas, $local, $num_livro_ata, $evento,
                            $promocao, $local_realizacao, $organizador,
                            $tipo_publicacao,
    ...
    case 'getTableData':
        $controller = ControleMemorabilia::getInstance();
        $_GET['sTable'] = 'Memorabilia'; //Nome da tabela
        $_GET['iTypeId'] = DOCUMENTOS_MEMORABILIA_ID; //ID do tipo do documento
    ...
    default:
        ...
        $template->set_content_file('admin/documentos/memorabilia/memorabilia.php');
