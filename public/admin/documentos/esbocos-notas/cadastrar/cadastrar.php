...
//$fontes = $controle_documentos->get_fontes(DOCUMENTOS_ESBOCOS_NOTAS_ID);
...
<div id="content">
    ...
    <br />
    <form id="add" action="<?php echo ADMIN_DOCUMENTOS_ESBOCOS_NOTAS_URI; ?>?action=add" method="post" class="inline">
        <fieldset>
