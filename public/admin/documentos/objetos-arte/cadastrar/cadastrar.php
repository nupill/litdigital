...
//$fontes = $controle_documentos->get_fontes(DOCUMENTOS_OBJETOS_ARTE_ID);
...
<div id="content">
    ...
    <br />
    <form id="add" action="<?php echo ADMIN_DOCUMENTOS_OBJETOS_ARTE_URI; ?>?action=add" method="post" class="inline">
        <fieldset>
