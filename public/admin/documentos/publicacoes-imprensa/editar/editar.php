...
$generos = $controle_documentos->get_generos(DOCUMENTOS_PUBLICACOES_IMPRENSA_ID);
...
$categorias = $controle_documentos->get_categorias(DOCUMENTOS_PUBLICACOES_IMPRENSA_ID);
...
<div id="content">
    <h2>
        ...
        <a href="<?php echo ADMIN_DOCUMENTOS_PUBLICACOES_IMPRENSA_URI; ?>"><?php echo __('Publicações na Imprensa');?></a> &raquo;
        <?php echo __('Editar');?>
    </h2>
    <br />
    <form id="update" action="<?php echo ADMIN_DOCUMENTOS_PUBLICACOES_IMPRENSA_URI; ?>?action=update&id=<?php echo $id; ?>" method="post" class="inline">
        <fieldset>
        ...
        <fieldset>
			...
			<p><label for="acervo"><?php echo __("Acervo");?></label>
	            ...
	            <input type="hidden" id="acervo_id" name="acervo_id"   
	            	...
	            	?> 
	            />
            </p>            <p><label for="localizacao"><?php echo __('Localização');?></label>
        ...
        <fieldset>
            ...
            <p><label for="fonte"><?php echo __('Fontes');?>*</label>
                ...
                <button id="rem_fonte" disabled="disabled" class="disabled" title="Remover da lista">-</button>
            </p>
            ...
            <p><label for="data_inicial"><?php echo __('Data inicial');?></label>
                <input type="text" id="data_inicial" name="data_inicial" value="<?php echo strftime('%d-%m-%Y', strtotime($documento['data_inicial'])); ?>" /></p>
            <p><label for="data_final"><?php echo __('Data final');?></label>
                <input type="text" id="data_final" name="data_final" value="<?php echo strftime('%d-%m-%Y', strtotime($documento['data_final'])); ?>" /></p>
            <div class="clear"></div>
            <p><label for="num_fasciculo"><?php echo __('Número do fascículo');?></label>
                <input type="text" id="num_fasciculo" name="num_fasciculo" value="<?php echo $documento['num_fasciculo']; ?>" /></p>
            <div class="clear"></div>
