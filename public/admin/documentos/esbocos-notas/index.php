...
require_once(APPLICATION_PATH . '/controllers/ControleNotas.php');
...
switch ($action) {
    ...
    case 'update':
        ...
        $controller = ControleNotas::getInstance();
        if ($action == 'add') {
    ...
    case 'getTableData':
        $controller = ControleNotas::getInstance();
        $_GET['sTable'] = 'Nota'; //Nome da tabela
        $_GET['iTypeId'] = DOCUMENTOS_ESBOCOS_NOTAS_ID; //ID do tipo do documento
    ...
    default:
        ...
        $template->set_content_file('admin/documentos/esbocos-notas/esbocos-notas.php');
