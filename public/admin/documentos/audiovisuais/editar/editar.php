...
$generos = $controle_documentos->get_generos(DOCUMENTOS_AUDIOVISUAIS_ID);
//var_dump($generosAtuais);
$idiomasAtuais = $controle_documentos->get_idiomas_new($id, array('id', 'descricao'));
//var_dump($idiomasAtuais);
$idiomas = $controle_documentos->get_idiomas();

$categorias = $controle_documentos->get_categorias(DOCUMENTOS_AUDIOVISUAIS_ID);
...
<div id="content">
    <h2>
        ...
        <a href="<?php echo ADMIN_DOCUMENTOS_AUDIOVISUAIS_URI; ?>"><?php echo __("Audiovisuais");?></a> &raquo;
        <?php echo __("Editar");?>
    </h2>
    <br />
    <form id="update" action="<?php echo ADMIN_DOCUMENTOS_AUDIOVISUAIS_URI; ?>?action=update&id=<?php echo $id; ?>" method="post" class="inline">
        <fieldset>
        ...
        <fieldset>
            ...
            <p><label for="autor"><?php echo __("Autores");?>*</label>
        ...
        <fieldset>
            ...
            <p><label for="direitos_autorais"><?php echo __("Direitos autorias");?></label>
