...
require_once(APPLICATION_PATH . '/controllers/ControleCorrespondencia.php');
...
switch ($action) {
    ...
    case 'update':
        ...
        $controller = ControleCorrespondencia::getInstance();
        if ($action == 'add') {
    ...
    case 'getTableData':
        $controller = ControleCorrespondencia::getInstance();
        $_GET['sTable'] = 'Correspondencia'; //Nome da tabela
        $_GET['iTypeId'] = DOCUMENTOS_CORRESPONDENCIAS_ID; //ID do tipo do documento
    ...
    default:
        ...
        $template->set_content_file('admin/documentos/correspondencia/correspondencia.php');
