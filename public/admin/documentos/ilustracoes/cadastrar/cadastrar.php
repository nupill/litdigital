...
//$fontes = $controle_documentos->get_fontes(DOCUMENTOS_ILUSTRACOES_ID);
...
<div id="content">
    ...
    <br />
    <form id="add" action="<?php echo ADMIN_DOCUMENTOS_ILUSTRACOES_URI; ?>?action=add" method="post" class="inline">
        <fieldset>
