...
// MUST (only one)
// please adjust
$repositoryName       = 'Biblioteca da literatura Digital - UFSC';
$baseURL			  = $MY_URI;
...
// MUST (multiple)
// please adjust
$adminEmail			= array('mailto:jean.pacherr@gmail.com'); 
...
// please adjust
$repositoryIdentifier = 'biblio.inf'; 
...
$SETS = array (
				array('setSpec'=>'obras', 'setName'=>'Obras literarias', 'setDescription'=>'') //,
