...
$generos = $controle_documentos->get_generos(DOCUMENTOS_MEMORABILIA_ID);

$idiomasAtuais = $controle_documentos->get_idiomas_new($id, array('id', 'descricao'));
$idiomas = $controle_documentos->get_idiomas();

$categorias = $controle_documentos->get_categorias(DOCUMENTOS_MEMORABILIA_ID);
...
<div id="content">
    <h2>
        ...
        <a href="<?php echo ADMIN_DOCUMENTOS_MEMORABILIA_URI; ?>"><?php echo __('Memorabilia');?></a> &raquo;
        <?php echo __('Editar');?>
    </h2>
    <br />
    <form id="update" action="<?php echo ADMIN_DOCUMENTOS_MEMORABILIA_URI; ?>?action=update&id=<?php echo $id; ?>" method="post" class="inline">
        <fieldset>
        ...
        <fieldset>
            ...
            <p><label for="local"><?php echo __('Local de produção');?></label>
                <input type="text" id="local" name="local" value="<?php echo $documento['local']; ?>" /></p>
            <p><label for="num_livro_ata"><?php echo __('Número do livro de atas');?></label>
                <input type="text" id="num_livro_ata" name="num_livro_ata" value="<?php echo $documento['num_livro_ata']; ?>" /></p>
            <div class="clear"></div>
            <p><label for="evento"><?php echo __('Número do evento');?></label>
                <input type="text" id="evento" name="evento" value="<?php echo $documento['evento']; ?>" /></p>
            <p><label for="promocao"><?php echo __('Promotor');?></label>
                <input type="text" id="promocao" name="promocao" value="<?php echo $documento['promocao']; ?>" /></p>
            <p><label for="local_realizacao"><?php echo __('Local de realização');?></label>
