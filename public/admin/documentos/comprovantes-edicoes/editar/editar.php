...
$generos = $controle_documentos->get_generos(DOCUMENTOS_COMPROVANTES_EDICOES_ID);
...
$categorias = $controle_documentos->get_categorias(DOCUMENTOS_COMPROVANTES_EDICOES_ID);
...
<div id="content">
    <h2>
        ...
        <a href="<?php echo ADMIN_DOCUMENTOS_COMPROVANTES_EDICOES_URI; ?>"><?php echo __('Comprovantes de Edições');?></a> &raquo;
        <?php echo __('Editar');?>
    </h2>
    <br />
    <form id="update" action="<?php echo ADMIN_DOCUMENTOS_COMPROVANTES_EDICOES_URI; ?>?action=update&id=<?php echo $id; ?>" method="post" class="inline">
        <fieldset>
        ...
        <fieldset>
            ...
            <p><label for="capitulo"><?php echo __('Capítulo');?></label>
                <input type="text" id="capitulo" name="capitulo" value="<?php echo $documento['capitulo']; ?>" /></p>
            <div class="clear"></div>
            <p><label for="pag_inicial"><?php echo __('Página inicial');?></label>
                <input type="text" id="pag_inicial" name="pag_inicial" value="<?php echo $documento['pag_inicial']; ?>" /></p>
            <p><label for="pag_final"><?php echo __('Página final');?></label>
                <input type="text" id="pag_final" name="pag_final" value="<?php echo $documento['pag_final']; ?>" /></p>
            <p><label for="tradutor"><?php echo __('Tradutor');?></label>
                <input type="text" id="tradutor" name="tradutor" value="<?php echo $documento['tradutor']; ?>" /></p>
            <div class="clear"></div>
