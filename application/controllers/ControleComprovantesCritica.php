...
class ControleComprovantesCritica extends ControleDocumentos {
    ...
    /**
     * Adiciona o Comprovante de Crítica no banco de dados
     *
    ...
    public function add(//Atributos do Documento:
                        ...
                        $local_publicacao = '', $edicao = '',
                        $local_realizacao = '', $organizador = '',
                        $tipo_publicacao = '', $autor_capitulo = '',
                        $titulo_capitulo = '', $pag_inicial_capitulo = '',
                        $pag_final_capitulo = '', $pag_inicial_artigo = '',
                        $pag_final_artigo = '', $congresso = '',
        ...
        //Validação dos campos do Comprovante de Critica
        ...
        $result = $this->add_documento(DOCUMENTOS_COMPROVANTES_CRITICA_ID, $titulo, $autores, $generos, $categoria, $fontes,
        ...
        $fields['local_realizacao'] = $local_realizacao;
        $fields['organizador'] = $organizador;
        $fields['tipo_publicacao'] = $tipo_publicacao;
        $fields['autor_capitulo'] = $autor_capitulo;
        $fields['titulo_capitulo'] = $titulo_capitulo;
        $fields['pag_inicial_capitulo'] = $pag_inicial_capitulo;
        $fields['pag_final_capitulo'] = $pag_final_capitulo;
        $fields['pag_inicial_artigo'] = $pag_inicial_artigo;
        $fields['pag_final_artigo'] = $pag_final_artigo;
        $fields['congresso'] = $congresso;

        try {
            $this->DB->insert('ComprovanteCritica', $fields, false);
        } catch (Exception $e) {
    ...
    /**
     * Atualiza o Comprovante de Crítica no banco de dados
     *
     * @return string Resultado da inserção no formato JSON
     */
    public function update(//Atributos do Documento:
                            ...
                            $local_publicacao = '', $edicao = '',
                            $local_realizacao = '', $organizador = '',
                            $tipo_publicacao = '', $autor_capitulo = '', // tipo de publicacao tem um conjunto definido
                            $titulo_capitulo = '', $pag_inicial_capitulo = '',
                            $pag_final_capitulo = '', $pag_inicial_artigo = '',
                            $pag_final_artigo = '', $congresso = '',
                            //Atributos das Mídias:
        ...
        try {
            $this->DB->update('ComprovanteCritica', $fields, $where);
        } catch (Exception $e) {
            Logger::log($e->getMessage(), __FILE__);
    ...
    /**
     * Valida os campos (parâmetros) do Comprovante de Crítica
     *
    ...
    private function validate_parameters($volume = '', $num_paginas = '',
        ...
        if ($pag_inicial_capitulo && !is_numeric($pag_inicial_capitulo)) {
            $invalid_fields['pag_inicial_capitulo'] = 'Página inicial do capítulo inválida';
        }
        if ($pag_final_capitulo && !is_numeric($pag_final_capitulo)) {
            $invalid_fields['pag_final_capitulo'] = 'Página final do capítulo inválida';
        }
        if ($pag_inicial_artigo && !is_numeric($pag_inicial_artigo)) {
            $invalid_fields['pag_inicial_artigo'] = 'Página inicial do artigo inválida';
        }
        if ($pag_final_artigo && !is_numeric($pag_final_artigo)) {
            $invalid_fields['pag_final_artigo'] = 'Página final do artigo inválida';
        }
