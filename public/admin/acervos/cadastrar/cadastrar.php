...
<div id="content">
	<h2>
		<a href="<?php echo ADMIN_URI; ?>"><?php echo __('Área administrativa');?></a> &raquo;
	 	<a href="<?php echo ADMIN_ACERVOS_URI; ?>"><?php echo __('Acervos');?></a> &raquo;
	 	<?php echo __('Cadastrar acervo');?>
	 </h2>
	<br />
	<br />
    <form id="add" action="<?php echo ADMIN_ACERVOS_URI; ?>?action=add" method="post" class="inline">
    	<fieldset>
    		<legend><?php echo __('Preencha os campos abaixo para incluir um acervo');?></legend>
    		<p><label for="descricao"><?php echo __('Nome do Acervo');?>*</label>
    		<input type="text" id="descricao" name="descricao" style="width: 800px" /></p>
    		<p></p>
    	</fieldset>
    ...
    var options = {
        ...
        success: function(response, status) {
            ...
            if (response && response.error == null) {
            	$('#status').html('<span class="success">'+"<?php echo __('Acervo cadastrado com sucesso');?>"+'!</span>');
            }
            else {
