...
class ControleVida extends ControleDocumentos {
    ...
    /**
     * Adiciona a Vida no banco de dados
     *
    ...
    public function add(//Atributos do Documento:
                        ...
                        //Atributos da Vida:
                        $num_paginas = '', $local = '', $indice_assunto = '',
        ...
        $result = $this->add_documento(DOCUMENTOS_VIDA_ID, $titulo, $autores, $generos, $categoria, $fontes,
        ...
        $fields['local'] = $local;
        $fields['indice_assunto'] = $indice_assunto;

        try {
            $this->DB->insert('Vida', $fields, false);
        }
        catch (Exception $e) {
    ...
    /**
     * Atualiza a Vida no banco de dados
     *
     * @return string Resultado da inserção no formato JSON
     */
    public function update(//Atributos do Documento:
        ...
        try {
            $this->DB->update('Vida', $fields, $where);
        }
        catch (Exception $e) {
            Logger::log($e->getMessage(), __FILE__);
    ...
    /**
     * Valida os campos (parâmetros) da Vida
     *
