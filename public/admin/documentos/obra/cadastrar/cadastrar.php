...
//$fontes = $controle_documentos->get_fontes(DOCUMENTOS_OBRA_ID);
...
<div id="content">
    ...
    <br />
    <form id="add" action="<?php echo ADMIN_DOCUMENTOS_OBRA_URI; ?>?action=add" method="post" class="inline">
        <fieldset>
        ...
        <fieldset>
            ...
            <p><label for="sigla"><?php echo __('Sigla');?></label>
                <input type="text" id="sigla" name="sigla" /></p>
            <div class="clear"></div>
