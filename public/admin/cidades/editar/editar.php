...
<div id="content">
	<h2>
		<a href="<?php echo ADMIN_URI; ?>"><?php echo __('Área administrativa');?></a> &raquo;
	 	<a href="<?php echo ADMIN_CIDADES_URI; ?>"><?php echo __('Cidades');?></a> &raquo;
	 	<?php echo __('Editar Cidade');?>
	</h2>
	<br />
	<br />
    <form id="update" action="<?php echo ADMIN_CIDADES_URI; ?>?action=update&id=<?php echo $id; ?>" method="post" class="inline">
        <fieldset>
            <legend><?php echo __('Utilize os campos abaixo para editar a cidade');?></legend>
            <p><label for="pais"><?php echo __('Pais');?>*</label>
            ...
            <p><label for="cidade"><?php echo __('Nome da cidade');?>*</label>
            <input type="text" id="cidade" name="cidade" style="width: 400px" value="<?php echo $cidadecorr['nome']; ?>" /></p>
            <p><label for="estado"><?php echo __('Estado');?></label>
            <select id="estado" name="estado" width: "100"  style="width: 100px" >
				<option value=""><?php echo __('Selecione');?></option>			
 			 <?php 			
                foreach ($estados as $estado) {
                ?>
                <option <?php if ($estado['id'] == $cidadecorr['estado_id']) {echo "selected='selected'";} ?> value="<?php echo $estado['id']; ?>"><?php echo $estado['sigla']; ?> 
                </option>
                <?php
                }
                ?>
            ...
            <input type="text" id="latitude" name="latitude" style="width: 200px" value="<?php echo $cidadecorr['lat']; ?>" />
			</p>
			<p>
			<label for="longitude"><?php echo __('Logitude');?></label>
            <input type="text" id="longitude" name="longitude" style="width: 200px" value="<?php echo $cidadecorr['lng']; ?>" />
            </p>
            </fieldset>
