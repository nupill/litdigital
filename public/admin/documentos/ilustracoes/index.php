...
require_once(APPLICATION_PATH . '/controllers/ControleIlustracoes.php');
...
switch ($action) {
    ...
    case 'update':
        ...
        $controller = ControleIlustracoes::getInstance();
        if ($action == 'add') {
    ...
    case 'getTableData':
        $controller = ControleIlustracoes::getInstance();
        $_GET['sTable'] = 'Ilustracao'; //Nome da tabela
        $_GET['iTypeId'] = DOCUMENTOS_ILUSTRACOES_ID; //ID do tipo do documento
    ...
    default:
        ...
        $template->set_content_file('admin/documentos/ilustracoes/ilustracoes.php');
