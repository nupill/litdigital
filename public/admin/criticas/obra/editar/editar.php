...
$controle_criticas = ControleCriticasObra::getInstance();
...
<div id="content">
	...
	<br />
	<br />
    <form id="update" action="<?php echo ADMIN_CRITICAS_OBRA_URI; ?>?action=update&id=<?php echo $id; ?>" method="post" class="inline">
        <fieldset>
    		...
    		<p><label for="obra"><?php echo __('Obra');?> *</label>
    		<input type="text" id="obra" name="obra" style="width: 500px" value="<?php echo $critica['Documento_titulo'] ?>" disabled="disabled"/></p>
    		<div class="clear"></div>
