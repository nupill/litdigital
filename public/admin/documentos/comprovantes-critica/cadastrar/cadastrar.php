...
//$fontes = $controle_documentos->get_fontes(DOCUMENTOS_COMPROVANTES_CRITICA_ID);
...
<div id="content">
    ...
    <br />
    <form id="add" action="<?php echo ADMIN_DOCUMENTOS_COMPROVANTES_CRITICA_URI; ?>?action=add" method="post" class="inline">
        <fieldset>
        ...
        <fieldset>
            ...
            <p><label for="idioma"><?php echo __('Idiomas');?>*</label>
				<select id="idioma" name="idioma" style="width: 385px">
                    ...
                    ?>
                </select>                <input type="hidden" id="idioma_id" name="idioma_id" />
