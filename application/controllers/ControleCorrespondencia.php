...
class ControleCorrespondencia extends ControleDocumentos {
    ...
    /**
     * Adiciona a Correspondência no banco de dados
     *
    ...
    public function add(//Atributos do Documento:
                        ...
                        //Atributos da Correspondência:
                        $num_paginas = '', $destinatario = '',
        ...
        //Validação dos campos da Correspondencia
        $invalid_fields = $this->validate_parameters($num_paginas);
        ...
        $result = $this->add_documento(DOCUMENTOS_CORRESPONDENCIAS_ID, $titulo, $autores, $generos, $categoria, $fontes,
        ...
        try {
            $this->DB->insert('Correspondencia', $fields, false);
        }
        catch (Exception $e) {
    ...
    /**
     * Atualiza a Correspondência no banco de dados
     *
     * @return string Resultado da inserção no formato JSON
     */
    public function update(//Atributos do Documento:
        ...
        //Validação dos campos de Correspondencia
        $invalid_fields = $this->validate_parameters($num_paginas);
        ...
        try {
            $this->DB->update('Correspondencia', $fields, $where);
        }
        catch (Exception $e) {
            Logger::log($e->getMessage(), __FILE__);
    ...
    /**
     * Valida os campos (parâmetros) da Correspondência
     *
